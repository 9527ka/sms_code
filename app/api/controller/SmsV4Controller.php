...
use app\api\service\smsV4Service;
use app\common\validate\smsV4Validate;
use app\api\exception\ApiServiceException;
use app\common\model\smsV4;
...
class SmsV4Controller extends ApiBaseController
{
    ...
    public function getCode(){
        ...
        //老人机
        // $lrjInfo = smsV4::where('mobile',$phone)->find();
        // if(!empty($lrjInfo)){
        ...
        //取匹配到的号
        $codeInfo = smsV4::where('mobile',$key1)->whereOr('mobile',$key2)->whereOr('mobile',$phone)->find();
        if(empty($codeInfo)){
