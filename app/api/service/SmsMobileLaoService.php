...
class SmsMobileLaoService extends ApiBaseService
{
    protected SmsMobileLao $model;

    public function __construct()
    {
        $this->model = new SmsMobileLao();
    }
    ...
    {
        try {
            $field = 'id,sms_url_id,mobile,is_send_check,check_result,create_time';
            $data  = $this->model
