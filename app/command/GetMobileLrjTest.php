...
class GetMobileLrjTest extends Command
{
    ...
    {
        // 指令配置
        $this->setName('getMobileLrjTest')
            ->setDescription('the getMobileLrjTest command');
    }

    protected function execute(Input $input, Output $output)
    {
        $this->_sendCheckPhone();die;
    ...
    private function _sendCheckPhone(){
        $str = SmsMobileLao::where('is_send_check',0)->field('GROUP_CONCAT(phone)')->select();
        echo $str;die;
